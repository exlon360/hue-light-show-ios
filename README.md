...
- Supports a bundled `HueLightShow/BridgeConfig.plist` for prefilled bridge setup in personal builds.
...
Edit `HueLightShow/BridgeConfig.plist` before building a personal IPA if you want the app to come up already pointed at your Hue Bridge after updates.
